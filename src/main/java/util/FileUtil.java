...
public class FileUtil {
        ...
        JavaPairRDD<String, List<String>> pairs = lines.mapToPair(
                ...
                new PairFunction<String, String, List<String>>() {
                    ...
                    public Tuple2<String, List<String>> call(String line) throws Exception {
                        ...
                        return new Tuple2<String, List<String>>(transLine, Arrays.asList("1", sb.append("第").append(String.valueOf(count++)).append("行").append(":").append(line).toString(), fileNum));
                    }
                });
    ...
    public static void resStat(JavaSparkContext jsc, int countOne, int countTwo
            , String[] eleOriOne
            , String[] eleOriTwo
            , List<String> commOne
            , List<String> commTwo
        ...
        switch (flag) {
            case 1:
                diffOne.add(Arrays.toString(Arrays.copyOfRange(eleOriOne, countTwo, countOne)));

                commOne.add(Arrays.toString(Arrays.copyOfRange(eleOriOne, 0, countTwo)));

                commTwo.add(Arrays.toString(Arrays.copyOfRange(eleOriTwo, 0, countTwo)));

                break;
            case -1:
                diffTwo.add(Arrays.toString(Arrays.copyOfRange(eleOriTwo, countOne, countTwo)));

                commOne.add(Arrays.toString(Arrays.copyOfRange(eleOriOne, 0, countOne)));

                commTwo.add(Arrays.toString(Arrays.copyOfRange(eleOriTwo, 0, countOne)));

                break;
            case 0:
                commOne.add(Arrays.toString(eleOriOne));

                commTwo.add(Arrays.toString(eleOriTwo));
    ...
    // 优化:分区器
    public static JavaPairRDD<String, List<String>> partitions(JavaPairRDD<String, List<String>> union, int num) {
